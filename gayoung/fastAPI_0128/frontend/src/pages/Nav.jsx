import { useContext } from 'react' // << 사용하는 파일마다 import해온다
import { AuthContext } from '@hooks/AuthContext.js' // << 사용하는 파일마다 import해온다

const Nav = () => {
  const auth = useContext(AuthContext) // << 변수 안에 함수를 넣는다
  return (
